...
export default function PayslipLayout({ children }) {
  return (
    <>
      ...
      <nav className="no-print fixed bottom-3 left-1/2 z-50 flex -translate-x-1/2 items-center gap-1 rounded-2xl border border-slate-200 bg-white/95 p-1.5 shadow-2xl shadow-slate-950/15 backdrop-blur md:bottom-5 md:gap-2">
