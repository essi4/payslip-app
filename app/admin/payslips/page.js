      ...
      <div className="form-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-grid">
            ...
            <div className="form-group"><label>۲. گروه مزدی</label><input value={form.job_group} readOnly /><small>از پرونده پرسنل؛ حقوق پایه دستی نیست.</small></div>
            ...
            <div className="form-group"><label>۳. تعداد روز کارکرد</label><input type="number" min="1" max={calculation.monthDays} value={form.work_days} onChange={(e) => updateForm("work_days", e.target.value)} /><small>حداکثر این ماه: {fa(calculation.monthDays)} روز</small></div>
